...
export function StatusBar() {
  ...
  if (isMobile) {
    return (
      <div className="h-7 shrink-0 bg-sidebar px-3 flex items-center justify-between text-xs text-muted-foreground">
        <StatusBarConnection />
  ...
  return (
    <div className="h-8 shrink-0 bg-sidebar px-4 flex items-center justify-between text-xs text-muted-foreground">
